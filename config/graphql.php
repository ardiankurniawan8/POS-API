...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                's_header' => Thunderlabid\Cashier\AL\Graphql\Queries\HeaderQuery::class,
                's_status' => Thunderlabid\Cashier\AL\Graphql\Queries\StatusQuery::class,
                's_bayar' => Thunderlabid\Cashier\AL\Graphql\Queries\BayarQuery::class,
                's_line' => Thunderlabid\Cashier\AL\Graphql\Queries\LineQuery::class,
            ],
            'mutation' => [
                'createHeader' => Thunderlabid\Cashier\AL\Graphql\Mutations\CreateHeader::class,
                'KonfirmasiBayar' => Thunderlabid\Cashier\AL\Graphql\Mutations\KonfirmasiBayar::class,
            ]
        ]
    ],
     ...
     */
    'types' => [
        Thunderlabid\Cashier\AL\Graphql\Types\headerType::class,
        Thunderlabid\Cashier\AL\Graphql\Types\statusType::class,
        Thunderlabid\Cashier\AL\Graphql\Types\bayarType::class,
        Thunderlabid\Cashier\AL\Graphql\Types\lineType::class
    ],
